            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="{{route('admin.dashboard')}}">
                        <img class="brand-logo" alt="SAVEMART logo"
                             src="{{URL::asset('assets/admin/images/logo/logo.png')}}">
                        <h3 class="brand-text">SAVEMART</h3>
                    </a>
                </li>
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">مرجبا
                  ...
                  <img style="height: 35px;" src="{{ URL::asset('assets/admin/images/avatar.png') }}"
                       alt="avatar"><i></i></span>
                        </a>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="{{URL::asset('assets/admin/images/portrait/small/avatar-s-19.png')}}"
                               alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                        ...
                        <span class="avatar avatar-sm avatar-busy rounded-circle">
                          <img src="{{ URL::asset('admin/images/portrait/small/avatar-s-2.png') }}" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="{{ URL::asset('admin/images/portrait/small/avatar-s-3.png') }}" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                        ...
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                          <img src="{{ URL::asset('admin/images/portrait/small/avatar-s-6.png') }}" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
